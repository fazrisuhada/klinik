...
<?php $__env->startSection('title', 'Add New Medicine'); ?>
...
unset($__errorArgs, $__bag); ?>" required>
                                ...
                                <option value="Tablet" <?php echo e(old('type') == 'Tablet' ? 'selected' : ''); ?>>
                                    <i class="fas fa-circle"></i> Tablet
                                </option>
                                <option value="Capsule" <?php echo e(old('type') == 'Capsule' ? 'selected' : ''); ?>>
                                    <i class="fas fa-capsules"></i> Capsule
                                </option>
                                <option value="Syrup" <?php echo e(old('type') == 'Syrup' ? 'selected' : ''); ?>>
                                    <i class="fas fa-flask"></i> Syrup
                                </option>
                                <option value="Injection" <?php echo e(old('type') == 'Injection' ? 'selected' : ''); ?>>
                                    <i class="fas fa-syringe"></i> Injection
                                </option>
                                <option value="Cream" <?php echo e(old('type') == 'Cream' ? 'selected' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                      placeholder="Enter medicine description, usage instructions, or notes..."><?php echo e(old('description')); ?></textarea>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH Z:\room\klinik_fazri\resources\views/medicines/create.blade.php ENDPATH**/ ?>